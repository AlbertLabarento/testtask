...
abstract class Controller extends BaseController
{
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    protected function successfulListResponse(?array $data = null, ?array $headers = null): JsonResponse
    {
        return \response()->json(array_map([$this,'mapData'], $data) ?? [], 200, $headers ?? []);
    }
    ...
    public function execute( string $taskName, array $params = [] )
    {
        return app()->make( $taskName, $params );
    }
}
